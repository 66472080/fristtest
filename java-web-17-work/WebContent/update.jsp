				...
				<div class="main">
					...
					<table width="50%" cellspacing="6">
						...
						<tr>
							...
							题号:<input type="text"   name="item.id" value="<%=item.getId()%>">
							&nbsp;&nbsp;&nbsp;&nbsp;
							题目:<input type="text"  name="item.qusetion" value="<%=item.getQusetion()%>">
							</td>
						</tr>						
						<tr>
							<td align="right">
							选项A:<input type="text"  name="item.option_a" value="<%=item.getOption_a()%>">
							</td>
						</tr>
						<tr>
							<td align="right">
							选项B:<input type="text"  name="item.option_b" value="<%=item.getOption_b()%>">
							</td>
						</tr>
						<tr>
							<td align="right">
							选项C:<input type="text"  name="item.option_c" value="<%=item.getOption_c()%>">
							</td>
						</tr>
						<tr>
							<td align="right">
							选项D:<input type="text"  name="item.option_d" value="<%=item.getOption_d()%>">
							</td>
						</tr>
						<tr>
							<td align="right">
							正确答案:<input type="text"  name="item.answer" value="<%=item.getAnswer()%>">
							</td>
						</tr>
						<tr>
							<td align="right">								
